...
protected:
	// Returns random position suitable for placing a new ship
	b2Vec2 get_rand_respawn_pos(); // TODO: respawn manager
	...
	Player* wall_player = nullptr; // id = -1; TODO: or not todo
	...
	// Determines which collisions are allowed and which are ignored
	CollisionFilter collision_filter;
	// Contact table (stores body pairs which are in contact)
...
public:
	// Creates new player, returns true if success
